 ...
 */
public class FoodListItemView extends RelativeLayout {
    ...
    public FoodListItemView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
    ...
    protected void onFinishInflate() {
        ...
        foodNameTextView = (TextView) findViewById(R.id.foodItemNameTextView);
        itemRatingBar = (RatingBar) findViewById(R.id.itemRatingBar);
        priceTextView = (TextView) findViewById(R.id.amountTextView);
    }
